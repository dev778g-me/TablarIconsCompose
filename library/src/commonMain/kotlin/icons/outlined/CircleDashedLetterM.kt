...
val Tablar.Outlined.CircleDashedLetterM: ImageVector
    get() {
        if (_CircleDashedLetterM != null) {
            return _CircleDashedLetterM!!
        }
        _CircleDashedLetterM = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterM",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterM: ImageVector? = null
