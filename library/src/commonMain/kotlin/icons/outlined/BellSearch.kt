...
val Tablar.Outlined.BellSearch: ImageVector
    get() {
        if (_BellSearch != null) {
            return _BellSearch!!
        }
        _BellSearch = ImageVector.Builder(
            name = "Outlined.BellSearch",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.685f, 2.984f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
