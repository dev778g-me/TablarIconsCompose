...
val Tablar.Outlined.BellQuestion: ImageVector
    get() {
        if (_BellQuestion != null) {
            return _BellQuestion!!
        }
        _BellQuestion = ImageVector.Builder(
            name = "Outlined.BellQuestion",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, 5.914f, 0.716f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
