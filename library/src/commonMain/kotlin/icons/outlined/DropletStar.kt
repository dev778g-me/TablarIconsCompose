...
val Tablar.Outlined.DropletStar: ImageVector
    get() {
        if (_DropletStar != null) {
            return _DropletStar!!
        }
        _DropletStar = ImageVector.Builder(
            name = "Outlined.DropletStar",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(7.106f, 7.106f, 0f, isMoreThanHalf = false, isPositiveArc = false, 3.547f, 1.517f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
