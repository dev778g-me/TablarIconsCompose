...
val Tablar.Outlined.DatabaseHeart: ImageVector
    get() {
        if (_DatabaseHeart != null) {
            return _DatabaseHeart!!
        }
        _DatabaseHeart = ImageVector.Builder(
            name = "Outlined.DatabaseHeart",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                curveToRelative(0f, 1.453f, 2.755f, 2.665f, 6.414f, 2.941f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
            ...
            path(
                ...
                moveTo(4f, 12f)
                verticalLineToRelative(6f)
                curveToRelative(0f, 1.579f, 3.253f, 2.873f, 7.383f, 2.991f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
