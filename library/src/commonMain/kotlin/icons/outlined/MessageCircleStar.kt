...
val Tablar.Outlined.MessageCircleStar: ImageVector
    get() {
        if (_MessageCircleStar != null) {
            return _MessageCircleStar!!
        }
        _MessageCircleStar = ImageVector.Builder(
            name = "Outlined.MessageCircleStar",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(9.757f, 9.757f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.817f, -0.869f)
