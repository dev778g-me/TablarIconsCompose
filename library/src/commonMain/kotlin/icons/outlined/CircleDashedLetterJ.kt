...
val Tablar.Outlined.CircleDashedLetterJ: ImageVector
    get() {
        if (_CircleDashedLetterJ != null) {
            return _CircleDashedLetterJ!!
        }
        _CircleDashedLetterJ = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterJ",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterJ: ImageVector? = null
