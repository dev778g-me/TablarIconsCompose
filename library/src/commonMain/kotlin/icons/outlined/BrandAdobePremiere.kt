...
val Tablar.Outlined.BrandAdobePremiere: ImageVector
    get() {
        if (_BrandAdobePremiere != null) {
            return _BrandAdobePremiere!!
        }
        _BrandAdobePremiere = ImageVector.Builder(
            name = "Outlined.BrandAdobePremiere",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
