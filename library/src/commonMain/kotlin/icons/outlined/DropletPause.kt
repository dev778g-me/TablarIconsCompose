    ...
    get() {
        ...
        _DropletPause = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(6.573f, 6.573f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.888f, -2.579f)
                ...
                arcToRelative(7.176f, 7.176f, 0f, isMoreThanHalf = false, isPositiveArc = false, 5.517f, 1.507f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
