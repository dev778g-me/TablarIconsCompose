...
val Tablar.Outlined.ShieldPin: ImageVector
    get() {
        if (_ShieldPin != null) {
            return _ShieldPin!!
        }
        _ShieldPin = ImageVector.Builder(
            name = "Outlined.ShieldPin",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(12f, 12f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.597f, 0.171f)
