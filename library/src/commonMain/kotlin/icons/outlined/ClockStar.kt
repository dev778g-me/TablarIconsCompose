...
val Tablar.Outlined.ClockStar: ImageVector
    get() {
        if (_ClockStar != null) {
            return _ClockStar!!
        }
        _ClockStar = ImageVector.Builder(
            name = "Outlined.ClockStar",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(9f, 9f, 0f, isMoreThanHalf = true, isPositiveArc = false, -9.966f, 9.51f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
