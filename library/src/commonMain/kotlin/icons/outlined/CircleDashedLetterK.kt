...
val Tablar.Outlined.CircleDashedLetterK: ImageVector
    get() {
        if (_CircleDashedLetterK != null) {
            return _CircleDashedLetterK!!
        }
        _CircleDashedLetterK = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterK",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterK: ImageVector? = null
