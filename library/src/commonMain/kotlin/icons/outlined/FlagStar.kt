...
val Tablar.Outlined.FlagStar: ImageVector
    get() {
        if (_FlagStar != null) {
            return _FlagStar!!
        }
        _FlagStar = ImageVector.Builder(
            name = "Outlined.FlagStar",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(5.001f, 5.001f, 0f, isMoreThanHalf = false, isPositiveArc = false, -6.475f, 0.449f)
