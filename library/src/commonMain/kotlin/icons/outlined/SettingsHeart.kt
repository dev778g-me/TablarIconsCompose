...
val Tablar.Outlined.SettingsHeart: ImageVector
    get() {
        if (_SettingsHeart != null) {
            return _SettingsHeart!!
        }
        _SettingsHeart = ImageVector.Builder(
            name = "Outlined.SettingsHeart",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(1.668f, 1.668f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.906f, -1.145f)
            ...
            path(
                ...
                arcToRelative(3.001f, 3.001f, 0f, isMoreThanHalf = true, isPositiveArc = false, -4.31f, 3.474f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
