...
val Tablar.Outlined.CashBanknoteHeart: ImageVector
    get() {
        if (_CashBanknoteHeart != null) {
            return _CashBanknoteHeart!!
        }
        _CashBanknoteHeart = ImageVector.Builder(
            name = "Outlined.CashBanknoteHeart",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(3.001f, 3.001f, 0f, isMoreThanHalf = true, isPositiveArc = false, -4.29f, 3.514f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
