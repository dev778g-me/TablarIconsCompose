...
val Tablar.Outlined.EyeHeart: ImageVector
    get() {
        if (_EyeHeart != null) {
            return _EyeHeart!!
        }
        _EyeHeart = ImageVector.Builder(
            name = "Outlined.EyeHeart",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = true, isPositiveArc = false, -2.855f, 2.37f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
                ...
                curveToRelative(3.332f, 0f, 6.15f, 1.714f, 8.454f, 5.14f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
