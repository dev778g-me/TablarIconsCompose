...
val Tablar.Outlined.AdjustmentsPin: ImageVector
    get() {
        if (_AdjustmentsPin != null) {
            return _AdjustmentsPin!!
        }
        _AdjustmentsPin = ImageVector.Builder(
            name = "Outlined.AdjustmentsPin",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = true, isPositiveArc = false, -1.071f, 3.69f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
