    ...
    get() {
        ...
        _HeartExclamation = ImageVector.Builder(
            ...
            path(
                ...
                arcToRelative(5f, 5f, 0f, isMoreThanHalf = true, isPositiveArc = true, 7.922f, 6.102f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
