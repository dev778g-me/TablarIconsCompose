...
val Tablar.Outlined.WorldCode: ImageVector
    get() {
        if (_WorldCode != null) {
            return _WorldCode!!
        }
        _WorldCode = ImageVector.Builder(
            name = "Outlined.WorldCode",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(9f, 9f, 0f, isMoreThanHalf = true, isPositiveArc = false, -9.47f, 7.964f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
