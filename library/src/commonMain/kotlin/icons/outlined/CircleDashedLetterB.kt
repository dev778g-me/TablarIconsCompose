...
val Tablar.Outlined.CircleDashedLetterB: ImageVector
    get() {
        if (_CircleDashedLetterB != null) {
            return _CircleDashedLetterB!!
        }
        _CircleDashedLetterB = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterB",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterB: ImageVector? = null
