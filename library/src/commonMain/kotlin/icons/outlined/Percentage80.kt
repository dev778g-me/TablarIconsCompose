...
val Tablar.Outlined.Percentage80: ImageVector
    get() {
        if (_Percentage80 != null) {
            return _Percentage80!!
        }
        _Percentage80 = ImageVector.Builder(
            name = "Outlined.Percentage80",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(12f, 3f)
                arcToRelative(9f, 9f, 0f, isMoreThanHalf = true, isPositiveArc = true, -8.497f, 6.025f)
