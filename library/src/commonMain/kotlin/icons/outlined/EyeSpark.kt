...
val Tablar.Outlined.EyeSpark: ImageVector
    get() {
        if (_EyeSpark != null) {
            return _EyeSpark!!
        }
        _EyeSpark = ImageVector.Builder(
            name = "Outlined.EyeSpark",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(11.669f, 17.994f)
                quadToRelative(-5.18f, -0.18f, -8.669f, -5.994f)
