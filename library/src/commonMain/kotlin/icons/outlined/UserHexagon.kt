...
val Tablar.Outlined.UserHexagon: ImageVector
    get() {
        if (_UserHexagon != null) {
            return _UserHexagon!!
        }
        _UserHexagon = ImageVector.Builder(
            name = "Outlined.UserHexagon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = true, 3.799f, -2.744f)
                horizontalLineToRelative(4f)
                arcToRelative(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = true, 3.798f, 2.741f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
