...
val Tablar.Outlined.BasketHeart: ImageVector
    get() {
        if (_BasketHeart != null) {
            return _BasketHeart!!
        }
        _BasketHeart = ImageVector.Builder(
            name = "Outlined.BasketHeart",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.233f, 3.066f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
