...
val Tablar.Outlined.HeartPin: ImageVector
    get() {
        if (_HeartPin != null) {
            return _HeartPin!!
        }
        _HeartPin = ImageVector.Builder(
            name = "Outlined.HeartPin",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(5f, 5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 8.5f, 5.179f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
