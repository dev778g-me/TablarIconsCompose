...
val Tablar.Outlined.CircleDashedLetterU: ImageVector
    get() {
        if (_CircleDashedLetterU != null) {
            return _CircleDashedLetterU!!
        }
        _CircleDashedLetterU = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterU",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterU: ImageVector? = null
