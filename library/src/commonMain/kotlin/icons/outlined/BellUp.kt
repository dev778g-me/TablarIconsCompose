...
val Tablar.Outlined.BellUp: ImageVector
    get() {
        if (_BellUp != null) {
            return _BellUp!!
        }
        _BellUp = ImageVector.Builder(
            name = "Outlined.BellUp",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(9f, 17f)
                verticalLineToRelative(1f)
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, 3.49f, 2.96f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
