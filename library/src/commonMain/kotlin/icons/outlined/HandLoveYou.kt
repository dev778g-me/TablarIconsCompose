...
val Tablar.Outlined.HandLoveYou: ImageVector
    get() {
        if (_HandLoveYou != null) {
            return _HandLoveYou!!
        }
        _HandLoveYou = ImageVector.Builder(
            name = "Outlined.HandLoveYou",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _HandLoveYou: ImageVector? = null
