...
val Tablar.Outlined.MoodSpark: ImageVector
    get() {
        if (_MoodSpark != null) {
            return _MoodSpark!!
        }
        _MoodSpark = ImageVector.Builder(
            name = "Outlined.MoodSpark",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(21f, 12f)
                arcToRelative(9f, 9f, 0f, isMoreThanHalf = true, isPositiveArc = false, -8.994f, 9f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
