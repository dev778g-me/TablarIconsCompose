...
val Tablar.Outlined.StarsOff: ImageVector
    get() {
        if (_StarsOff != null) {
            return _StarsOff!!
        }
        _StarsOff = ImageVector.Builder(
            name = "Outlined.StarsOff",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                lineToRelative(-1.757f, 1.707f)
                lineToRelative(0.414f, 2.41f)
                arcToRelative(0.39f, 0.39f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.014f, 0.187f)
