...
val Tablar.Outlined.CloudCode: ImageVector
    get() {
        if (_CloudCode != null) {
            return _CloudCode!!
        }
        _CloudCode = ImageVector.Builder(
            name = "Outlined.CloudCode",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(3.468f, 3.468f, 0f, isMoreThanHalf = false, isPositiveArc = true, 3.307f, 2.444f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
