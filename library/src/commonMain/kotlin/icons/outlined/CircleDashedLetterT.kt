...
val Tablar.Outlined.CircleDashedLetterT: ImageVector
    get() {
        if (_CircleDashedLetterT != null) {
            return _CircleDashedLetterT!!
        }
        _CircleDashedLetterT = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterT",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterT: ImageVector? = null
