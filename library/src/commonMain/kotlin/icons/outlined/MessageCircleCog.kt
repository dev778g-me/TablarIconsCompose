...
val Tablar.Outlined.MessageCircleCog: ImageVector
    get() {
        if (_MessageCircleCog != null) {
            return _MessageCircleCog!!
        }
        _MessageCircleCog = ImageVector.Builder(
            name = "Outlined.MessageCircleCog",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(9.868f, 9.868f, 0f, isMoreThanHalf = false, isPositiveArc = true, -4.296f, -0.98f)
