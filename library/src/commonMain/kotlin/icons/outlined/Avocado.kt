...
val Tablar.Outlined.Avocado: ImageVector
    get() {
        if (_Avocado != null) {
            return _Avocado!!
        }
        _Avocado = ImageVector.Builder(
            name = "Outlined.Avocado",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(17.8f, 14.04f)
                arcToRelative(3.905f, 3.905f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.337f, -2.075f)
                ...
                curveToRelative(0f, 1.946f, 0.715f, 3.668f, 2.145f, 5.168f)
                curveToRelative(1.5f, 1.429f, 3.222f, 2.144f, 5.168f, 2.144f)
                curveToRelative(1.945f, 0f, 3.667f, -0.715f, 5.167f, -2.145f)
