...
val Tablar.Outlined.BrandEnvato: ImageVector
    get() {
        if (_BrandEnvato != null) {
            return _BrandEnvato!!
        }
        _BrandEnvato = ImageVector.Builder(
            name = "Outlined.BrandEnvato",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                curveToRelative(0f, 0.201f, 0.03f, 0.55f, 0.071f, 1.03f)
