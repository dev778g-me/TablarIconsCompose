...
val Tablar.Outlined.CircleDashedMinus: ImageVector
    get() {
        if (_CircleDashedMinus != null) {
            return _CircleDashedMinus!!
        }
        _CircleDashedMinus = ImageVector.Builder(
            name = "Outlined.CircleDashedMinus",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedMinus: ImageVector? = null
