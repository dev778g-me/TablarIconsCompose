...
val Tablar.Outlined.DropletCog: ImageVector
    get() {
        if (_DropletCog != null) {
            return _DropletCog!!
        }
        _DropletCog = ImageVector.Builder(
            name = "Outlined.DropletCog",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(6.702f, 6.702f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.357f, -0.683f)
                ...
                arcToRelative(7.144f, 7.144f, 0f, isMoreThanHalf = false, isPositiveArc = false, 4.518f, 1.58f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
