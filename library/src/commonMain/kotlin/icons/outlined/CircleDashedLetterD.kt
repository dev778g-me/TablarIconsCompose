...
val Tablar.Outlined.CircleDashedLetterD: ImageVector
    get() {
        if (_CircleDashedLetterD != null) {
            return _CircleDashedLetterD!!
        }
        _CircleDashedLetterD = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterD",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterD: ImageVector? = null
