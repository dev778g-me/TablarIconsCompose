...
val Tablar.Outlined.VaccineBottleOff: ImageVector
    get() {
        if (_VaccineBottleOff != null) {
            return _VaccineBottleOff!!
        }
        _VaccineBottleOff = ImageVector.Builder(
            name = "Outlined.VaccineBottleOff",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(8.7f, 8.705f)
                arcToRelative(1.806f, 1.806f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.2f, 0.045f)
