...
val Tablar.Outlined.ClockShield: ImageVector
    get() {
        if (_ClockShield != null) {
            return _ClockShield!!
        }
        _ClockShield = ImageVector.Builder(
            name = "Outlined.ClockShield",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(21f, 12f)
                arcToRelative(9f, 9f, 0f, isMoreThanHalf = true, isPositiveArc = false, -8.98f, 9f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
