...
val Tablar.Outlined.BasketPin: ImageVector
    get() {
        if (_BasketPin != null) {
            return _BasketPin!!
        }
        _BasketPin = ImageVector.Builder(
            name = "Outlined.BasketPin",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = true, isPositiveArc = false, -1.866f, 2.72f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
