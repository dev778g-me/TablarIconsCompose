...
val Tablar.Outlined.SettingsX: ImageVector
    get() {
        if (_SettingsX != null) {
            return _SettingsX!!
        }
        _SettingsX = ImageVector.Builder(
            name = "Outlined.SettingsX",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(1.724f, 1.724f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.065f, 2.572f)
                curveToRelative(1.756f, 0.426f, 1.756f, 2.924f, 0f, 3.35f)
                arcToRelative(1.66f, 1.66f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.324f, 0.114f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
