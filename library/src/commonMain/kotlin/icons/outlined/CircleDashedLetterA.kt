...
val Tablar.Outlined.CircleDashedLetterA: ImageVector
    get() {
        if (_CircleDashedLetterA != null) {
            return _CircleDashedLetterA!!
        }
        _CircleDashedLetterA = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterA",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterA: ImageVector? = null
