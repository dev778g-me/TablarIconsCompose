...
val Tablar.Outlined.WorldCog: ImageVector
    get() {
        if (_WorldCog != null) {
            return _WorldCog!!
        }
        _WorldCog = ImageVector.Builder(
            name = "Outlined.WorldCog",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(21f, 12f)
                arcToRelative(9f, 9f, 0f, isMoreThanHalf = true, isPositiveArc = false, -8.979f, 9f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
            ...
            path(
                ...
                moveTo(12.5f, 3f)
                arcToRelative(16.992f, 16.992f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.522f, 10.376f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
