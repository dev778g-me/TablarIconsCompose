...
val Tablar.Outlined.SettingsCode: ImageVector
    get() {
        if (_SettingsCode != null) {
            return _SettingsCode!!
        }
        _SettingsCode = ImageVector.Builder(
            name = "Outlined.SettingsCode",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(1.666f, 1.666f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.157f, -1.241f)
