...
val Tablar.Outlined.ShieldCode: ImageVector
    get() {
        if (_ShieldCode != null) {
            return _ShieldCode!!
        }
        _ShieldCode = ImageVector.Builder(
            name = "Outlined.ShieldCode",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(12f, 12f, 0f, isMoreThanHalf = false, isPositiveArc = false, 8.5f, 3f)
                arcToRelative(12f, 12f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.078f, 7.024f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
