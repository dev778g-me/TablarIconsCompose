...
val Tablar.Outlined.MapPinPause: ImageVector
    get() {
        if (_MapPinPause != null) {
            return _MapPinPause!!
        }
        _MapPinPause = ImageVector.Builder(
            name = "Outlined.MapPinPause",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(8f, 8f, 0f, isMoreThanHalf = true, isPositiveArc = true, 13.337f, -3.413f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
