...
val Tablar.Outlined.FileTextShield: ImageVector
    get() {
        if (_FileTextShield != null) {
            return _FileTextShield!!
        }
        _FileTextShield = ImageVector.Builder(
            name = "Outlined.FileTextShield",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(0.997f, 0.997f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1f, 1f)
