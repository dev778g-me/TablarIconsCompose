...
val Tablar.Outlined.CircleDashedLetterO: ImageVector
    get() {
        if (_CircleDashedLetterO != null) {
            return _CircleDashedLetterO!!
        }
        _CircleDashedLetterO = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterO",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterO: ImageVector? = null
