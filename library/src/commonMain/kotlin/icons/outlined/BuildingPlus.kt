...
val Tablar.Outlined.BuildingPlus: ImageVector
    get() {
        if (_BuildingPlus != null) {
            return _BuildingPlus!!
        }
        _BuildingPlus = ImageVector.Builder(
            name = "Outlined.BuildingPlus",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _BuildingPlus: ImageVector? = null
