...
val Tablar.Outlined.LayersSelectedBottom: ImageVector
    get() {
        if (_LayersSelectedBottom != null) {
            return _LayersSelectedBottom!!
        }
        _LayersSelectedBottom = ImageVector.Builder(
            name = "Outlined.LayersSelectedBottom",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
