...
val Tablar.Outlined.DropletHeart: ImageVector
    get() {
        if (_DropletHeart != null) {
            return _DropletHeart!!
        }
        _DropletHeart = ImageVector.Builder(
            name = "Outlined.DropletHeart",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(6.734f, 6.734f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.224f, -0.405f)
                ...
                arcToRelative(7.117f, 7.117f, 0f, isMoreThanHalf = false, isPositiveArc = false, 3.824f, 1.548f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
