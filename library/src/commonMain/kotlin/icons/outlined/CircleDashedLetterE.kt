...
val Tablar.Outlined.CircleDashedLetterE: ImageVector
    get() {
        if (_CircleDashedLetterE != null) {
            return _CircleDashedLetterE!!
        }
        _CircleDashedLetterE = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterE",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterE: ImageVector? = null
