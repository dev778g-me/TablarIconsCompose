...
val Tablar.Outlined.CircleDashedLetterF: ImageVector
    get() {
        if (_CircleDashedLetterF != null) {
            return _CircleDashedLetterF!!
        }
        _CircleDashedLetterF = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterF",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterF: ImageVector? = null
