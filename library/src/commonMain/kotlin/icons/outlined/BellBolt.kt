...
val Tablar.Outlined.BellBolt: ImageVector
    get() {
        if (_BellBolt != null) {
            return _BellBolt!!
        }
        _BellBolt = ImageVector.Builder(
            name = "Outlined.BellBolt",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(9f, 17f)
                verticalLineToRelative(1f)
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, 4.368f, 2.67f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
