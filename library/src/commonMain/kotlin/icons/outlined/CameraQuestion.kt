...
val Tablar.Outlined.CameraQuestion: ImageVector
    get() {
        if (_CameraQuestion != null) {
            return _CameraQuestion!!
        }
        _CameraQuestion = ImageVector.Builder(
            name = "Outlined.CameraQuestion",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = true, isPositiveArc = false, -1.507f, 3.005f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
