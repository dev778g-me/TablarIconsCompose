...
val Tablar.Outlined.FlagBitcoin: ImageVector
    get() {
        if (_FlagBitcoin != null) {
            return _FlagBitcoin!!
        }
        _FlagBitcoin = ImageVector.Builder(
            name = "Outlined.FlagBitcoin",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(5f, 5f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.222f, -0.882f)
