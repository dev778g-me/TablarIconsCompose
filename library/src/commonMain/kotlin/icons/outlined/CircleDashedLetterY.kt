...
val Tablar.Outlined.CircleDashedLetterY: ImageVector
    get() {
        if (_CircleDashedLetterY != null) {
            return _CircleDashedLetterY!!
        }
        _CircleDashedLetterY = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterY",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterY: ImageVector? = null
