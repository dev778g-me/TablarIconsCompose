...
val Tablar.Outlined.MapPinPin: ImageVector
    get() {
        if (_MapPinPin != null) {
            return _MapPinPin!!
        }
        _MapPinPin = ImageVector.Builder(
            name = "Outlined.MapPinPin",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.196f, -0.426f)
                lineToRelative(-4.244f, -4.243f)
                arcToRelative(8f, 8f, 0f, isMoreThanHalf = true, isPositiveArc = true, 13.657f, -5.62f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
