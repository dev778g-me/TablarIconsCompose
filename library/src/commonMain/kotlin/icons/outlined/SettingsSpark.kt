...
val Tablar.Outlined.SettingsSpark: ImageVector
    get() {
        if (_SettingsSpark != null) {
            return _SettingsSpark!!
        }
        _SettingsSpark = ImageVector.Builder(
            name = "Outlined.SettingsSpark",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(11.992f, 21f)
                curveToRelative(-0.728f, -0.003f, -1.455f, -0.442f, -1.667f, -1.317f)
                ...
                curveToRelative(1.543f, -0.94f, 3.31f, 0.826f, 2.37f, 2.37f)
                arcToRelative(1.724f, 1.724f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.065f, 2.572f)
                curveToRelative(0.882f, 0.214f, 1.32f, 0.95f, 1.317f, 1.684f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
