...
val Tablar.Outlined.SettingsExclamation: ImageVector
    get() {
        if (_SettingsExclamation != null) {
            return _SettingsExclamation!!
        }
        _SettingsExclamation = ImageVector.Builder(
            name = "Outlined.SettingsExclamation",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(1.724f, 1.724f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.329f, 1.282f)
