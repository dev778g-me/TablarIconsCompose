...
val Tablar.Outlined.CircleDashedPlus: ImageVector
    get() {
        if (_CircleDashedPlus != null) {
            return _CircleDashedPlus!!
        }
        _CircleDashedPlus = ImageVector.Builder(
            name = "Outlined.CircleDashedPlus",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedPlus: ImageVector? = null
