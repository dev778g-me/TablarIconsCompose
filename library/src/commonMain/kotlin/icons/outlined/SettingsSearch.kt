...
val Tablar.Outlined.SettingsSearch: ImageVector
    get() {
        if (_SettingsSearch != null) {
            return _SettingsSearch!!
        }
        _SettingsSearch = ImageVector.Builder(
            name = "Outlined.SettingsSearch",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(1.67f, 1.67f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.321f, -1.282f)
            ...
            path(
                ...
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = true, isPositiveArc = false, -3.29f, 3.29f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
