...
val Tablar.Outlined.RectangularPrismPlus: ImageVector
    get() {
        if (_RectangularPrismPlus != null) {
            return _RectangularPrismPlus!!
        }
        _RectangularPrismPlus = ImageVector.Builder(
            name = "Outlined.RectangularPrismPlus",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
