...
val Tablar.Outlined.WorldStar: ImageVector
    get() {
        if (_WorldStar != null) {
            return _WorldStar!!
        }
        _WorldStar = ImageVector.Builder(
            name = "Outlined.WorldStar",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(21f, 12f)
                arcToRelative(9f, 9f, 0f, isMoreThanHalf = true, isPositiveArc = false, -9.968f, 8.948f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
            ...
            path(
                ...
                moveTo(11.5f, 3f)
                arcToRelative(17.001f, 17.001f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.886f, 13.802f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
                ...
                moveTo(12.5f, 3f)
                arcToRelative(16.982f, 16.982f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.549f, 8.01f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
