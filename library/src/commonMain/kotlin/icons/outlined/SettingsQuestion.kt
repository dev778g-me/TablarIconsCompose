...
val Tablar.Outlined.SettingsQuestion: ImageVector
    get() {
        if (_SettingsQuestion != null) {
            return _SettingsQuestion!!
        }
        _SettingsQuestion = ImageVector.Builder(
            name = "Outlined.SettingsQuestion",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                curveToRelative(1.543f, -0.94f, 3.31f, 0.826f, 2.37f, 2.37f)
                arcToRelative(1.724f, 1.724f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.065f, 2.572f)
                arcToRelative(1.67f, 1.67f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.179f, 0.982f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
                ...
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = true, isPositiveArc = false, -1.211f, 1.892f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
