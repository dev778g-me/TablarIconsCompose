...
val Tablar.Outlined.TiltShiftOff: ImageVector
    get() {
        if (_TiltShiftOff != null) {
            return _TiltShiftOff!!
        }
        _TiltShiftOff = ImageVector.Builder(
            name = "Outlined.TiltShiftOff",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(8.56f, 3.69f)
                arcToRelative(9f, 9f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.577f, 0.263f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
            ...
            path(
                ...
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.862f, 2.795f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
