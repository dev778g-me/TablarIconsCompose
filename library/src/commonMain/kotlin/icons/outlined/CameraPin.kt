...
val Tablar.Outlined.CameraPin: ImageVector
    get() {
        if (_CameraPin != null) {
            return _CameraPin!!
        }
        _CameraPin = ImageVector.Builder(
            name = "Outlined.CameraPin",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(3.001f, 3.001f, 0f, isMoreThanHalf = true, isPositiveArc = false, -2.933f, 3.634f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
