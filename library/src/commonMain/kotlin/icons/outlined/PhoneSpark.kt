...
val Tablar.Outlined.PhoneSpark: ImageVector
    get() {
        if (_PhoneSpark != null) {
            return _PhoneSpark!!
        }
        _PhoneSpark = ImageVector.Builder(
            name = "Outlined.PhoneSpark",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(16f, 16f, 0f, isMoreThanHalf = false, isPositiveArc = true, -8.584f, -13.225f)
