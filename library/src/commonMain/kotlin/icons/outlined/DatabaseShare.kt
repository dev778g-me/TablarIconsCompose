...
val Tablar.Outlined.DatabaseShare: ImageVector
    get() {
        if (_DatabaseShare != null) {
            return _DatabaseShare!!
        }
        _DatabaseShare = ImageVector.Builder(
            name = "Outlined.DatabaseShare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                curveToRelative(0f, 1.657f, 3.582f, 3f, 8f, 3f)
                curveToRelative(0.361f, 0f, 0.716f, -0.009f, 1.065f, -0.026f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
