...
val Tablar.Outlined.HeartCancel: ImageVector
    get() {
        if (_HeartCancel != null) {
            return _HeartCancel!!
        }
        _HeartCancel = ImageVector.Builder(
            name = "Outlined.HeartCancel",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(5f, 5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 7.993f, 6.01f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
