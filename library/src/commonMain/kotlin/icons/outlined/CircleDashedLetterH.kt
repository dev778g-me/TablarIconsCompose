...
val Tablar.Outlined.CircleDashedLetterH: ImageVector
    get() {
        if (_CircleDashedLetterH != null) {
            return _CircleDashedLetterH!!
        }
        _CircleDashedLetterH = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterH",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterH: ImageVector? = null
