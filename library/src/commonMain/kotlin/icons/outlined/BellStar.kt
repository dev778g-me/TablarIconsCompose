...
val Tablar.Outlined.BellStar: ImageVector
    get() {
        if (_BellStar != null) {
            return _BellStar!!
        }
        _BellStar = ImageVector.Builder(
            name = "Outlined.BellStar",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(7f, 7f, 0f, isMoreThanHalf = false, isPositiveArc = true, 3.88f, 5f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
                ...
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.15f, 2.878f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
