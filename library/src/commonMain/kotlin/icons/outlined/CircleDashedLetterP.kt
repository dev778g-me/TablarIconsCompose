...
val Tablar.Outlined.CircleDashedLetterP: ImageVector
    get() {
        if (_CircleDashedLetterP != null) {
            return _CircleDashedLetterP!!
        }
        _CircleDashedLetterP = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterP",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterP: ImageVector? = null
