...
val Tablar.Outlined.MichelinStarGreen: ImageVector
    get() {
        if (_MichelinStarGreen != null) {
            return _MichelinStarGreen!!
        }
        _MichelinStarGreen = ImageVector.Builder(
            name = "Outlined.MichelinStarGreen",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                curveToRelative(1.726f, 0f, 2.959f, -1.234f, 2.959f, -2.963f)
                curveToRelative(0f, -1.73f, -1.233f, -2.965f, -3.02f, -2.965f)
                curveToRelative(-0.37f, 0f, -0.617f, 0f, -0.925f, 0.062f)
                ...
                curveToRelative(-1.788f, 0f, -3.021f, 1.235f, -3.021f, 2.964f)
                curveToRelative(0f, 1.729f, 1.233f, 2.964f, 3.02f, 2.964f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
                ...
                moveTo(4.073f, 21f)
                curveToRelative(4.286f, -2.756f, 5.9f, -5.254f, 7.927f, -9f)
            }
        }.build()
