...
val Tablar.Outlined.BubblePlus: ImageVector
    get() {
        if (_BubblePlus != null) {
            return _BubblePlus!!
        }
        _BubblePlus = ImageVector.Builder(
            name = "Outlined.BubblePlus",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(5.333f, 5.333f, 0f, isMoreThanHalf = false, isPositiveArc = true, 4.45f, 6.89f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
