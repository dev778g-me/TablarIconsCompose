...
val Tablar.Outlined.Paw: ImageVector
    get() {
        if (_Paw != null) {
            return _Paw!!
        }
        _Paw = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(14.7f, 13.5f)
                curveToRelative(-1.1f, -2f, -1.441f, -2.5f, -2.7f, -2.5f)
                curveToRelative(-1.259f, 0f, -1.736f, 0.755f, -2.836f, 2.747f)
                ...
                curveToRelative(1.013f, 0f, 1.8f, -0.823f, 1.8f, -2f)
                curveToRelative(0f, -0.285f, -0.049f, -0.697f, -0.146f, -0.962f)
            ...
            path(
                ...
                moveTo(9.474f, 9f)
                curveToRelative(0.055f, 0f, 0.109f, 0f, 0.163f, -0.011f)
