...
val Tablar.Outlined.ShieldUp: ImageVector
    get() {
        if (_ShieldUp != null) {
            return _ShieldUp!!
        }
        _ShieldUp = ImageVector.Builder(
            name = "Outlined.ShieldUp",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(13.12f, 13.12f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.442f, 0.124f)
                ...
                arcToRelative(12f, 12f, 0f, isMoreThanHalf = false, isPositiveArc = false, 8.5f, 3f)
                arcToRelative(12f, 12f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.119f, 6.336f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
