...
val Tablar.Outlined.MapPinHeart: ImageVector
    get() {
        if (_MapPinHeart != null) {
            return _MapPinHeart!!
        }
        _MapPinHeart = ImageVector.Builder(
            name = "Outlined.MapPinHeart",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(15f, 11f)
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = true, isPositiveArc = false, -3.973f, 2.839f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
                ...
                arcToRelative(1.991f, 1.991f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.173f, -0.57f)
                lineToRelative(-4.244f, -4.243f)
                arcToRelative(8f, 8f, 0f, isMoreThanHalf = true, isPositiveArc = true, 13.657f, -5.588f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
