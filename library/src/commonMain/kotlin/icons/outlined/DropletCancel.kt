...
val Tablar.Outlined.DropletCancel: ImageVector
    get() {
        if (_DropletCancel != null) {
            return _DropletCancel!!
        }
        _DropletCancel = ImageVector.Builder(
            name = "Outlined.DropletCancel",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(6.659f, 6.659f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.542f, -1.137f)
                ...
                arcToRelative(7.154f, 7.154f, 0f, isMoreThanHalf = false, isPositiveArc = false, 4.826f, 1.572f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
