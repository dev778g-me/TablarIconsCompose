...
val Tablar.Outlined.Percentage20: ImageVector
    get() {
        if (_Percentage20 != null) {
            return _Percentage20!!
        }
        _Percentage20 = ImageVector.Builder(
            name = "Outlined.Percentage20",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(12f, 3f)
                arcToRelative(9f, 9f, 0f, isMoreThanHalf = false, isPositiveArc = true, 8.497f, 6.025f)
