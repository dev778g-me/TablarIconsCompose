...
val Tablar.Outlined.Percentage60: ImageVector
    get() {
        if (_Percentage60 != null) {
            return _Percentage60!!
        }
        _Percentage60 = ImageVector.Builder(
            name = "Outlined.Percentage60",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(12f, 3f)
                arcToRelative(9f, 9f, 0f, isMoreThanHalf = true, isPositiveArc = true, -5.162f, 16.373f)
