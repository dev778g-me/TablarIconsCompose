...
val Tablar.Outlined.WorldSearch: ImageVector
    get() {
        if (_WorldSearch != null) {
            return _WorldSearch!!
        }
        _WorldSearch = ImageVector.Builder(
            name = "Outlined.WorldSearch",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(12.5f, 3f)
                arcToRelative(16.984f, 16.984f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.574f, 8.62f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
