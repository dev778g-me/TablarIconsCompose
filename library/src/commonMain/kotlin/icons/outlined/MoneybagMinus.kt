...
val Tablar.Outlined.MoneybagMinus: ImageVector
    get() {
        if (_MoneybagMinus != null) {
            return _MoneybagMinus!!
        }
        _MoneybagMinus = ImageVector.Builder(
            name = "Outlined.MoneybagMinus",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, 15.943f, -0.958f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
