...
val Tablar.Outlined.MapPinQuestion: ImageVector
    get() {
        if (_MapPinQuestion != null) {
            return _MapPinQuestion!!
        }
        _MapPinQuestion = ImageVector.Builder(
            name = "Outlined.MapPinQuestion",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(8f, 8f, 0f, isMoreThanHalf = true, isPositiveArc = true, 13.657f, -5.584f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
