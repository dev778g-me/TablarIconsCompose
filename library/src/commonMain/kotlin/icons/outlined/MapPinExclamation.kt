...
val Tablar.Outlined.MapPinExclamation: ImageVector
    get() {
        if (_MapPinExclamation != null) {
            return _MapPinExclamation!!
        }
        _MapPinExclamation = ImageVector.Builder(
            name = "Outlined.MapPinExclamation",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(8f, 8f, 0f, isMoreThanHalf = true, isPositiveArc = true, 13.592f, -4.638f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
