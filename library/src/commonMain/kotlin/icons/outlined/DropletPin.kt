...
val Tablar.Outlined.DropletPin: ImageVector
    get() {
        if (_DropletPin != null) {
            return _DropletPin!!
        }
        _DropletPin = ImageVector.Builder(
            name = "Outlined.DropletPin",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(7.163f, 7.163f, 0f, isMoreThanHalf = false, isPositiveArc = false, 5.102f, 1.554f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
