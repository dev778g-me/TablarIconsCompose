...
val Tablar.Outlined.CircleDashedLetterL: ImageVector
    get() {
        if (_CircleDashedLetterL != null) {
            return _CircleDashedLetterL!!
        }
        _CircleDashedLetterL = ImageVector.Builder(
            name = "Outlined.CircleDashedLetterL",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CircleDashedLetterL: ImageVector? = null
