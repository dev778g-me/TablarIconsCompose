...
val Tablar.Outlined.SortDescendingSmallBig: ImageVector
    get() {
        if (_SortDescendingSmallBig != null) {
            return _SortDescendingSmallBig!!
        }
        _SortDescendingSmallBig = ImageVector.Builder(
            name = "Outlined.SortDescendingSmallBig",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(0.667f, 0.667f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.667f, -0.667f)
