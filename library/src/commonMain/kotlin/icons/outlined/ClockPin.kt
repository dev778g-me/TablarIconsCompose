...
val Tablar.Outlined.ClockPin: ImageVector
    get() {
        if (_ClockPin != null) {
            return _ClockPin!!
        }
        _ClockPin = ImageVector.Builder(
            name = "Outlined.ClockPin",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(9f, 9f, 0f, isMoreThanHalf = true, isPositiveArc = false, -8.313f, 9.698f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
