...
val Tablar.Outlined.MapPinStar: ImageVector
    get() {
        if (_MapPinStar != null) {
            return _MapPinStar!!
        }
        _MapPinStar = ImageVector.Builder(
            name = "Outlined.MapPinStar",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(15f, 11f)
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = true, isPositiveArc = false, -3.908f, 2.86f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
                ...
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.472f, -0.35f)
                lineToRelative(-4.244f, -4.243f)
                arcToRelative(8f, 8f, 0f, isMoreThanHalf = true, isPositiveArc = true, 13.646f, -6.079f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
