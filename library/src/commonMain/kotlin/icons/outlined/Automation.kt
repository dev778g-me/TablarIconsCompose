...
val Tablar.Outlined.Automation: ImageVector
    get() {
        if (_Automation != null) {
            return _Automation!!
        }
        _Automation = ImageVector.Builder(
            name = "Outlined.Automation",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(13f, 20.693f)
                curveToRelative(-0.905f, 0.628f, -2.36f, 0.292f, -2.675f, -1.01f)
                ...
                curveToRelative(1.543f, -0.94f, 3.31f, 0.826f, 2.37f, 2.37f)
                arcToRelative(1.724f, 1.724f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.065f, 2.572f)
                curveToRelative(1.492f, 0.362f, 1.716f, 2.219f, 0.674f, 3.03f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
