...
val Tablar.Outlined.DropletMinus: ImageVector
    get() {
        if (_DropletMinus != null) {
            return _DropletMinus!!
        }
        _DropletMinus = ImageVector.Builder(
            name = "Outlined.DropletMinus",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(6.538f, 6.538f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.882f, -4.206f)
                ...
                arcToRelative(7.163f, 7.163f, 0f, isMoreThanHalf = false, isPositiveArc = false, 5.089f, 1.555f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
