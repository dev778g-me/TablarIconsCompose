...
val Tablar.Outlined.NavigationMinus: ImageVector
    get() {
        if (_NavigationMinus != null) {
            return _NavigationMinus!!
        }
        _NavigationMinus = ImageVector.Builder(
            name = "Outlined.NavigationMinus",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                moveTo(17.5f, 15f)
                curveToRelative(-1.232f, -2.67f, -3.065f, -6.67f, -5.5f, -12f)
