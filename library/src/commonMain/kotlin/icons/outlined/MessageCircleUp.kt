...
val Tablar.Outlined.MessageCircleUp: ImageVector
    get() {
        if (_MessageCircleUp != null) {
            return _MessageCircleUp!!
        }
        _MessageCircleUp = ImageVector.Builder(
            name = "Outlined.MessageCircleUp",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(9.869f, 9.869f, 0f, isMoreThanHalf = false, isPositiveArc = true, -4.304f, -0.98f)
