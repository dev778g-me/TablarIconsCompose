...
val Tablar.Outlined.BrandYarn: ImageVector
    get() {
        if (_BrandYarn != null) {
            return _BrandYarn!!
        }
        _BrandYarn = ImageVector.Builder(
            name = "Outlined.BrandYarn",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(42.469f, 42.469f, 0f, isMoreThanHalf = false, isPositiveArc = true, -4.498f, 0.412f)
                ...
                curveToRelative(0f, -0.828f, 0.622f, -1.674f, 1.235f, -2.211f)
                arcToRelative(6.811f, 6.811f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.46f, -3.143f)
                arcToRelative(7.414f, 7.414f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.208f, -2.615f)
                ...
                curveToRelative(0f, 0f, 0.781f, -2.43f, 1.533f, -1.936f)
                curveToRelative(0.415f, 0.653f, 0.671f, 1.218f, 0.967f, 1.936f)
                curveToRelative(0f, 0f, 1.15f, -0.7f, 1.25f, -0.5f)
                ...
                arcToRelative(5.848f, 5.848f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.984f, -1.145f)
                curveToRelative(0.735f, -0.066f, 0.988f, -0.035f, 1.22f, 1f)
                curveToRelative(0.232f, 1.035f, -0.346f, 1.406f, -0.744f, 1.506f)
                curveToRelative(0f, 0f, -2.09f, 0.675f, -2.911f, 1.302f)
            }
        }.build()
