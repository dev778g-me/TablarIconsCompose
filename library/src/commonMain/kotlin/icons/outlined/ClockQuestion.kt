...
val Tablar.Outlined.ClockQuestion: ImageVector
    get() {
        if (_ClockQuestion != null) {
            return _ClockQuestion!!
        }
        _ClockQuestion = ImageVector.Builder(
            name = "Outlined.ClockQuestion",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(9f, 9f, 0f, isMoreThanHalf = true, isPositiveArc = false, -5.717f, 9.06f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
