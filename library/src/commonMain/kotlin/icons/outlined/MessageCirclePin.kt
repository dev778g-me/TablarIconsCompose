...
val Tablar.Outlined.MessageCirclePin: ImageVector
    get() {
        if (_MessageCirclePin != null) {
            return _MessageCirclePin!!
        }
        _MessageCirclePin = ImageVector.Builder(
            name = "Outlined.MessageCirclePin",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(9.891f, 9.891f, 0f, isMoreThanHalf = false, isPositiveArc = true, -4.637f, -0.974f)
