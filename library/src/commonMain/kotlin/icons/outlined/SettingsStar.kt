...
val Tablar.Outlined.SettingsStar: ImageVector
    get() {
        if (_SettingsStar != null) {
            return _SettingsStar!!
        }
        _SettingsStar = ImageVector.Builder(
            name = "Outlined.SettingsStar",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                arcToRelative(1.723f, 1.723f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2.573f, -1.066f)
                ...
                curveToRelative(1.543f, -0.94f, 3.31f, 0.826f, 2.37f, 2.37f)
                arcToRelative(1.724f, 1.724f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.065f, 2.572f)
                arcToRelative(1.67f, 1.67f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.106f, 0.831f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
                ...
                arcToRelative(3.001f, 3.001f, 0f, isMoreThanHalf = true, isPositiveArc = false, -4.457f, 3.364f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
