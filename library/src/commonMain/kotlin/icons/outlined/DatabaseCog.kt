...
val Tablar.Outlined.DatabaseCog: ImageVector
    get() {
        if (_DatabaseCog != null) {
            return _DatabaseCog!!
        }
        _DatabaseCog = ImageVector.Builder(
            name = "Outlined.DatabaseCog",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(
                ...
                curveToRelative(0f, 1.657f, 3.582f, 3f, 8f, 3f)
                curveToRelative(0.21f, 0f, 0.42f, -0.003f, 0.626f, -0.01f)
            }
            path(
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2f,
