...
val Tablar.Filled.Exposure: ImageVector
    get() {
        if (_Exposure != null) {
            return _Exposure!!
        }
        _Exposure = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                verticalLineToRelative(14f)
                curveToRelative(0f, 0.29f, 0.123f, 0.55f, 0.321f, 0.732f)
                lineToRelative(1.61f, -1.584f)
                arcToRelative(973f, 973f, 0f, isMoreThanHalf = false, isPositiveArc = false, 6.69f, -6.675f)
                lineToRelative(7.094f, -7.173f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.715f, -0.3f)
