...
val Tablar.Filled.FileDelta: ImageVector
    get() {
        if (_FileDelta != null) {
            return _FileDelta!!
        }
        _FileDelta = ImageVector.Builder(
            name = "Filled.FileDelta",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.788f, 0f)
