...
val Tablar.Filled.BrandDribbble: ImageVector
    get() {
        ...
        _BrandDribbble = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(22.877f, 22.877f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.056f, 4.863f)
                lineToRelative(0.064f, 0.644f)
                lineToRelative(0.126f, 1.431f)
                arcToRelative(10f, 10f, 0f, isMoreThanHalf = false, isPositiveArc = true, -9.15f, -0.98f)
                ...
                arcToRelative(9.997f, 9.997f, 0f, isMoreThanHalf = false, isPositiveArc = true, -4.319f, 6.704f)
                ...
                arcToRelative(24.91f, 24.91f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.052f, 2.098f)
                curveToRelative(-2.276f, 0.77f, -4.142f, 2.053f, -6.144f, 3.967f)
                lineToRelative(-0.355f, 0.344f)
                lineToRelative(-2.236f, 2.24f)
                arcToRelative(10f, 10f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.917f, -6.741f)
                ...
                arcToRelative(26.112f, 26.112f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.163f, -2.38f)
                curveToRelative(1.393f, -0.695f, 2.757f, -1.597f, 4.179f, -2.75f)
                lineToRelative(0.428f, -0.354f)
                lineToRelative(0.816f, -0.682f)
                arcToRelative(10f, 10f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.098f, 5.409f)
                ...
                arcToRelative(10f, 10f, 0f, isMoreThanHalf = false, isPositiveArc = true, 5.074f, -6.593f)
                close()
                moveTo(17f, 3.34f)
                ...
                arcToRelative(10f, 10f, 0f, isMoreThanHalf = false, isPositiveArc = true, 7.717f, 0.964f)
                close()
            }
        }.build()
