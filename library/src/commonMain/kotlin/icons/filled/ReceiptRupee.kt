...
val Tablar.Filled.ReceiptRupee: ImageVector
    get() {
        if (_ReceiptRupee != null) {
            return _ReceiptRupee!!
        }
        _ReceiptRupee = ImageVector.Builder(
            name = "Filled.ReceiptRupee",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(4.01f, 4.01f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.538f, -2.77f)
                lineToRelative(1.126f, -0.001f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0f, -2f)
                horizontalLineToRelative(-1.126f)
                arcToRelative(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.33f, -0.855f)
