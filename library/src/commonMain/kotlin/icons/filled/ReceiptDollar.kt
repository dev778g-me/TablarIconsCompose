    ...
    get() {
        ...
        _ReceiptDollar = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.034f, -0.108f)
                ...
                curveToRelative(-0.403f, 0.013f, -0.75f, -0.18f, -0.934f, -0.5f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.732f, 1f)
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = false, 2.505f, 1.5f)
                lineToRelative(0.161f, -0.001f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = true, isPositiveArc = false, 2f, 0.001f)
