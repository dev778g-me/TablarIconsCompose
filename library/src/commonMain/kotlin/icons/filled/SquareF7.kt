...
val Tablar.Filled.SquareF7: ImageVector
    get() {
        if (_SquareF7 != null) {
            return _SquareF7!!
        }
        _SquareF7 = ImageVector.Builder(
            name = "Filled.SquareF7",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.962f, 0.37f)
                lineToRelative(1.5f, -6f)
                lineToRelative(0.021f, -0.11f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.991f, -1.132f)
                close()
                moveTo(10f, 8f)
