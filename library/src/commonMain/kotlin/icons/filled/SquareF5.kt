...
val Tablar.Filled.SquareF5: ImageVector
    get() {
        if (_SquareF5 != null) {
            return _SquareF5!!
        }
        _SquareF5 = ImageVector.Builder(
            name = "Filled.SquareF5",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.857f, 0.764f)
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.893f, 0.45f)
                curveToRelative(0f, 0.867f, 0.63f, 1.587f, 1.458f, 1.726f)
                lineToRelative(0.148f, 0.018f)
                lineToRelative(0.144f, 0.006f)
                horizontalLineToRelative(1.25f)
                lineToRelative(0.157f, -0.006f)
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.819f, -1.683f)
                lineToRelative(0.019f, -0.162f)
                lineToRelative(0.005f, -0.149f)
                verticalLineToRelative(-1f)
                lineToRelative(-0.006f, -0.157f)
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.683f, -1.819f)
