...
val Tablar.Filled.FileSad: ImageVector
    get() {
        if (_FileSad != null) {
            return _FileSad!!
        }
        _FileSad = ImageVector.Builder(
            name = "Filled.FileSad",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(0.176f, -0.005f)
                close()
                moveTo(14.571f, 17.18f)
                arcToRelative(4.5f, 4.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, -5.142f, 0f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = true, isPositiveArc = false, 1.142f, 1.64f)
                arcToRelative(2.5f, 2.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.858f, 0f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.142f, -1.64f)
                moveToRelative(-4.565f, -5.18f)
