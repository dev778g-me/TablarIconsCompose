...
val Tablar.Filled.ChartAreaLine: ImageVector
    get() {
        ...
        _ChartAreaLine = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.382f, -0.15f)
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.1f, 0.303f)
                lineToRelative(-0.115f, -0.049f)
                lineToRelative(-3.254f, -1.626f)
                lineToRelative(-2.499f, 3.332f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.295f, 0.269f)
                lineToRelative(-0.105f, -0.069f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.269f, -1.295f)
                lineToRelative(0.069f, -0.105f)
                lineToRelative(3f, -4f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.137f, -0.341f)
