...
val Tablar.Filled.PlayCard7: ImageVector
    get() {
        if (_PlayCard7 != null) {
            return _PlayCard7!!
        }
        _PlayCard7 = ImageVector.Builder(
            name = "Filled.PlayCard7",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = true, isPositiveArc = false, 1.897f, 0.632f)
