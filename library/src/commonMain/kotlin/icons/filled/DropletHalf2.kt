...
val Tablar.Filled.DropletHalf2: ImageVector
    get() {
        ...
        _DropletHalf2 = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(7.566f, 7.566f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.043f, 3.167f)
                ...
                curveToRelative(-2.969f, 2.402f, -7.286f, 2.402f, -10.255f, 0f)
                curveToRelative(-1.904f, -1.54f, -2.904f, -3.787f, -2.865f, -6.071f)
                arcToRelative(1.052f, 1.052f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.013f, -0.333f)
                arcToRelative(7.66f, 7.66f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.913f, -3.176f)
                ...
                arcToRelative(5.607f, 5.607f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.651f, 1.61f)
                horizontalLineToRelative(11.723f)
                arcToRelative(5.444f, 5.444f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.49f, -1.313f)
                lineToRelative(-0.141f, -0.251f)
                lineToRelative(-4.891f, -7.261f)
                arcToRelative(0.428f, 0.428f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.5f, -0.145f)
                close()
            }
        }.build()
