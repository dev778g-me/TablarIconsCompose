...
val Tablar.Filled.SquareRoundedArrowDown: ImageVector
    get() {
        if (_SquareRoundedArrowDown != null) {
            return _SquareRoundedArrowDown!!
        }
        _SquareRoundedArrowDown = ImageVector.Builder(
            name = "Filled.SquareRoundedArrowDown",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(1.008f, 1.008f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.112f, 0.097f)
