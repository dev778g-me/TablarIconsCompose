...
val Tablar.Filled.BrandGithub: ImageVector
    get() {
        ...
        _BrandGithub = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(13.3f, 13.3f, 0f, isMoreThanHalf = false, isPositiveArc = true, 4.59f, -0.08f)
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.53f, 0.514f)
                arcToRelative(5.2f, 5.2f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.397f, 2.91f)
                ...
                curveToRelative(0f, 3.855f, -1.659f, 5.883f, -4.644f, 6.68f)
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.564f, -1.918f)
                ...
                arcToRelative(5.03f, 5.03f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.021f, -0.824f)
                ...
                arcToRelative(5.6f, 5.6f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.908f, -3.051f)
                lineToRelative(0.152f, -0.222f)
                lineToRelative(0.122f, -0.163f)
                lineToRelative(-0.045f, -0.196f)
                arcToRelative(5.2f, 5.2f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.145f, -2.642f)
                lineToRelative(0.1f, -0.282f)
                lineToRelative(0.106f, -0.253f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.529f, -0.514f)
                lineToRelative(0.144f, -0.047f)
