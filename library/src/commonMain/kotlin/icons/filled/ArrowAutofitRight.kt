    ...
    get() {
        ...
        _ArrowAutofitRight = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(3f, 3f, 0f, isMoreThanHalf = false, isPositiveArc = true, 5.12f, -2.03f)
                arcToRelative(0.515f, 0.515f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.879f, -0.363f)
