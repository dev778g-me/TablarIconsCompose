...
val Tablar.Filled.BrandTwitter: ImageVector
    get() {
        ...
        _BrandTwitter = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.685f, 0.092f)
                ...
                arcToRelative(0.997f, 0.997f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.231f, 0.057f)
                lineToRelative(-0.086f, 0.038f)
                arcToRelative(7.46f, 7.46f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.88f, 0.36f)
