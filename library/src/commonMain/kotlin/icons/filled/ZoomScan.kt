...
val Tablar.Filled.ZoomScan: ImageVector
    get() {
        if (_ZoomScan != null) {
            return _ZoomScan!!
        }
        _ZoomScan = ImageVector.Builder(
            name = "Filled.ZoomScan",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(11f, 7f)
                arcToRelative(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = true, 3.446f, 6.031f)
                lineToRelative(2.261f, 2.262f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -1.414f, 1.414f)
                lineToRelative(-2.262f, -2.26f)
                lineToRelative(-0.031f, 0.017f)
                arcToRelative(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = true, -6f, -3.464f)
