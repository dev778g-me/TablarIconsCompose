...
val Tablar.Filled.FileSignal: ImageVector
    get() {
        if (_FileSignal != null) {
            return _FileSignal!!
        }
        _FileSignal = ImageVector.Builder(
            name = "Filled.FileSignal",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(2.5f, 2.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0f, -3.536f)
