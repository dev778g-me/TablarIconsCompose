...
val Tablar.Filled.Poo: ImageVector
    get() {
        if (_Poo != null) {
            return _Poo!!
        }
        _Poo = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(3.5f, 3.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.718f, 1.22f)
                lineToRelative(0.125f, 0.179f)
                arcToRelative(3.5f, 3.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.567f, 2.243f)
                lineToRelative(-0.006f, 0.049f)
                lineToRelative(0.032f, 0.025f)
                arcToRelative(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.476f, 2.8f)
                lineToRelative(0.01f, 0.191f)
                lineToRelative(0.15f, 0.125f)
                arcToRelative(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.29f, 3.693f)
                lineToRelative(-0.042f, 0.208f)
                curveToRelative(-0.4f, 1.728f, -1.89f, 2.986f, -3.72f, 3.092f)
                horizontalLineToRelative(-10.176f)
                arcToRelative(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.638f, -7.008f)
                lineToRelative(0.14f, -0.118f)
                lineToRelative(0.011f, -0.19f)
                arcToRelative(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.476f, -2.798f)
                lineToRelative(0.032f, -0.025f)
                lineToRelative(-0.006f, -0.048f)
                arcToRelative(3.5f, 3.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.452f, -2.058f)
                lineToRelative(0.114f, -0.186f)
                curveToRelative(0.603f, -0.912f, 1.598f, -1.49f, 2.755f, -1.564f)
                horizontalLineToRelative(0.164f)
                curveToRelative(0.743f, 0f, 1.26f, -1.242f, 0.606f, -2.553f)
                lineToRelative(0.006f, 0.015f)
                lineToRelative(-0.01f, -0.017f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.095f, -0.323f)
                lineToRelative(-0.007f, -0.117f)
                curveToRelative(0f, -0.654f, 0.539f, -1.031f, 1.063f, -1.005f)
