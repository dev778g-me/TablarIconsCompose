...
val Tablar.Filled.SquareRoundedArrowLeft: ImageVector
    get() {
        if (_SquareRoundedArrowLeft != null) {
            return _SquareRoundedArrowLeft!!
        }
        _SquareRoundedArrowLeft = ImageVector.Builder(
            name = "Filled.SquareRoundedArrowLeft",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(1.037f, 1.037f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.2f, 0.284f)
                lineToRelative(-0.022f, 0.052f)
                arcToRelative(0.95f, 0.95f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.06f, 0.222f)
                lineToRelative(-0.008f, 0.067f)
                lineToRelative(-0.002f, 0.063f)
                verticalLineToRelative(-0.035f)
                verticalLineToRelative(0.073f)
                arcToRelative(1.034f, 1.034f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.07f, 0.352f)
                lineToRelative(0.023f, 0.052f)
                lineToRelative(0.03f, 0.061f)
                lineToRelative(0.022f, 0.037f)
                arcToRelative(1.2f, 1.2f, 0f, isMoreThanHalf = false, isPositiveArc = false, 0.05f, 0.074f)
