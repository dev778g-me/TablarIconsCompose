...
val Tablar.Filled.Sun: ImageVector
    get() {
        if (_Sun != null) {
            return _Sun!!
        }
        _Sun = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(-0.094f, -0.083f)
                lineToRelative(-0.7f, -0.7f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.218f, -1.567f)
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                lineToRelative(-0.094f, -0.083f)
                lineToRelative(-0.7f, -0.7f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.217f, -1.567f)
                lineToRelative(0.102f, 0.07f)
                close()
            }
            path(fill = SolidColor(Color.Black)) {
