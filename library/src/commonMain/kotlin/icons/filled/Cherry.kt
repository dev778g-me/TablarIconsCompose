...
val Tablar.Filled.Cherry: ImageVector
    get() {
        if (_Cherry != null) {
            return _Cherry!!
        }
        _Cherry = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(0.998f, 0.998f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.182f, 0.727f)
                lineToRelative(-0.022f, 0.111f)
                lineToRelative(-0.03f, 0.092f)
                curveToRelative(-0.99f, 2.725f, -0.666f, 5.158f, 0.679f, 7.706f)
                arcToRelative(4f, 4f, 0f, isMoreThanHalf = true, isPositiveArc = true, -4.613f, 4.152f)
                lineToRelative(-0.005f, -0.2f)
                lineToRelative(0.005f, -0.2f)
                arcToRelative(4.002f, 4.002f, 0f, isMoreThanHalf = false, isPositiveArc = true, 2.5f, -3.511f)
                ...
                arcToRelative(4.5f, 4.5f, 0f, isMoreThanHalf = true, isPositiveArc = true, -7.064f, 3.906f)
                lineToRelative(-0.004f, -0.212f)
                lineToRelative(0.005f, -0.212f)
                arcToRelative(4.5f, 4.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 5.2f, -4.233f)
                ...
                curveToRelative(4.018f, -2.922f, 8.16f, -2.922f, 12.177f, 0f)
                close()
            }
        }.build()
