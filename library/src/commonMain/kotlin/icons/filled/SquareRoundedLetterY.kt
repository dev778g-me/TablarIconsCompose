...
val Tablar.Filled.SquareRoundedLetterY: ImageVector
    get() {
        if (_SquareRoundedLetterY != null) {
            return _SquareRoundedLetterY!!
        }
        _SquareRoundedLetterY = ImageVector.Builder(
            name = "Filled.SquareRoundedLetterY",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.3f, 0.558f)
