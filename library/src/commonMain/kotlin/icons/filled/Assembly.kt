...
val Tablar.Filled.Assembly: ImageVector
    get() {
        if (_Assembly != null) {
            return _Assembly!!
        }
        _Assembly = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(3.34f, 3.34f, 0f, isMoreThanHalf = false, isPositiveArc = true, 3.24f, 0.015f)
                moveToRelative(-0.64f, 5.343f)
                arcToRelative(2.03f, 2.03f, 0f, isMoreThanHalf = false, isPositiveArc = false, -2f, -0.014f)
                lineToRelative(-3.023f, 1.804f)
                arcToRelative(1.99f, 1.99f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.002f, 1.736f)
                verticalLineToRelative(3.278f)
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = false, 1.03f, 1.75f)
                ...
                arcToRelative(2f, 2f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.725f, -1.391f)
                lineToRelative(-0.092f, -0.07f)
                lineToRelative(-0.056f, -0.047f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.096f, -0.064f)
                close()
            }
        }.build()
