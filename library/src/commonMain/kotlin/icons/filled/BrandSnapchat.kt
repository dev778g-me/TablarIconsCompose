...
val Tablar.Filled.BrandSnapchat: ImageVector
    get() {
        ...
        _BrandSnapchat = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                moveTo(12f, 1.96f)
                arcToRelative(5.88f, 5.88f, 0f, isMoreThanHalf = false, isPositiveArc = true, 5.882f, 5.882f)
                curveToRelative(0f, 0.618f, 0.008f, 1.174f, 0.03f, 1.678f)
                ...
                arcToRelative(0.98f, 0.98f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.46f, 0.636f)
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.197f, 0.28f)
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.098f, 0.049f)
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.904f, 0.573f)
                curveToRelative(-1.067f, 0f, -1.798f, 0.25f, -2.879f, 0.868f)
                ...
                arcToRelative(15f, 15f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.447f, -0.25f)
                lineToRelative(-0.426f, -0.246f)
                curveToRelative(-1.081f, -0.618f, -1.812f, -0.868f, -2.879f, -0.868f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.904f, -0.573f)
                curveToRelative(-0.422f, -0.894f, -0.559f, -1.165f, -0.715f, -1.41f)
                arcToRelative(1.4f, 1.4f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.558f, -0.525f)
                curveToRelative(-0.228f, -0.13f, -0.47f, -0.243f, -1.227f, -0.577f)
                lineToRelative(0.02f, 0.007f)
                lineToRelative(-0.013f, -0.003f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.098f, -0.05f)
                ...
                arcToRelative(0.98f, 0.98f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.461f, -0.636f)
                lineToRelative(0.048f, -0.025f)
