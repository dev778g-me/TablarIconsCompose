...
val Tablar.Filled.Boom: ImageVector
    get() {
        if (_Boom != null) {
            return _Boom!!
        }
        _Boom = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.543f, -1.693f)
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.051f, -0.233f)
                lineToRelative(-0.002f, -0.045f)
                lineToRelative(-0.003f, -0.068f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.06f, -0.328f)
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.115f, -0.032f)
                lineToRelative(0.004f, -0.002f)
