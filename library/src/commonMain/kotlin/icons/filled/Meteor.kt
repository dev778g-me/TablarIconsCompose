...
val Tablar.Filled.Meteor: ImageVector
    get() {
        if (_Meteor != null) {
            return _Meteor!!
        }
        _Meteor = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                curveToRelative(0.846f, 0f, 1.293f, 0.973f, 0.791f, 1.612f)
                lineToRelative(-0.074f, 0.085f)
                lineToRelative(-6.9f, 7.095f)
                arcToRelative(7.5f, 7.5f, 0f, isMoreThanHalf = true, isPositiveArc = true, -10.21f, -10.974f)
                ...
                arcToRelative(3.5f, 3.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, -3.495f, 3.308f)
