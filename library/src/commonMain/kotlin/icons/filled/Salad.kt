...
val Tablar.Filled.Salad: ImageVector
    get() {
        if (_Salad != null) {
            return _Salad!!
        }
        _Salad = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(14f, 14f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.078f, -1f)
                verticalLineToRelative(-1f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1f, -1f)
                horizontalLineToRelative(1.755f)
                curveToRelative(0.138f, 0f, 0.287f, 0.034f, 0.44f, 0.092f)
                lineToRelative(0.835f, -3.335f)
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.5f, -0.605f)
                ...
                curveToRelative(-1.712f, 0f, -3.003f, 0.31f, -3.922f, 0.88f)
                arcToRelative(3.5f, 3.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.143f, 2.12f)
                horizontalLineToRelative(3.774f)
                curveToRelative(0.127f, -0.615f, 0.194f, -1.4f, 0.261f, -2.714f)
                close()
                moveTo(10.5f, 9f)
                arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, -1.414f, 1f)
                horizontalLineToRelative(2.828f)
                arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.845f, -0.888f)
                lineToRelative(-0.166f, -0.056f)
                arcToRelative(1.5f, 1.5f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.403f, -0.056f)
                moveToRelative(-0.864f, -3.424f)
                lineToRelative(-0.415f, 1.665f)
                arcToRelative(3.5f, 3.5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 1.502f, -0.234f)
                arcToRelative(6f, 6f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0.497f, -0.442f)
                close()
            }
        }.build()
